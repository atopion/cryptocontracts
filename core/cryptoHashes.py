...
class CryptoHashes:
    ...
    @staticmethod
    def U8TO64_BIG(p):
        return ((np.uint64(CryptoHashes.U8TO32_BIG(p)) << np.uint64(32)) | np.uint64(CryptoHashes.U8TO32_BIG(p)) + np.uint64(4))

    @staticmethod
    def U64TO8_BIG(p, v):
        CryptoHashes.U32TO8_BIG((p), np.uint32((v) >> np.uint32(32)))
        CryptoHashes.U32TO8_BIG((p) + 4, np.uint32((v)))
    ...
    class Keccak1600:
        ...
        def thetaD(self):
            self.d[0] = self.c[4] ^ CryptoHashes.leftRotateLong(self.c[1], 1)
            self.d[1] = self.c[0] ^ CryptoHashes.leftRotateLong(self.c[2], 1)
            self.d[2] = self.c[1] ^ CryptoHashes.leftRotateLong(self.c[3], 1)
            self.d[3] = self.c[2] ^ CryptoHashes.leftRotateLong(self.c[4], 1)
            self.d[4] = self.c[3] ^ CryptoHashes.leftRotateLong(self.c[0], 1)

        def rhoPi(self):
            self.b[0][0] = CryptoHashes.leftRotateLong(self.laneArray[0][0], self.ROTATION_CONSTANTS_FOR_WIDTH_1600[0][0])
            self.b[1][3] = CryptoHashes.leftRotateLong(self.laneArray[0][1], self.ROTATION_CONSTANTS_FOR_WIDTH_1600[0][1])
            self.b[2][1] = CryptoHashes.leftRotateLong(self.laneArray[0][2], self.ROTATION_CONSTANTS_FOR_WIDTH_1600[0][2])
            self.b[3][4] = CryptoHashes.leftRotateLong(self.laneArray[0][3], self.ROTATION_CONSTANTS_FOR_WIDTH_1600[0][3])
            self.b[4][2] = CryptoHashes.leftRotateLong(self.laneArray[0][4], self.ROTATION_CONSTANTS_FOR_WIDTH_1600[0][4])

            self.b[0][2] = CryptoHashes.leftRotateLong(self.laneArray[1][0], self.ROTATION_CONSTANTS_FOR_WIDTH_1600[1][0])
            self.b[1][0] = CryptoHashes.leftRotateLong(self.laneArray[1][1], self.ROTATION_CONSTANTS_FOR_WIDTH_1600[1][1])
            self.b[2][3] = CryptoHashes.leftRotateLong(self.laneArray[1][2], self.ROTATION_CONSTANTS_FOR_WIDTH_1600[1][2])
            self.b[3][1] = CryptoHashes.leftRotateLong(self.laneArray[1][3], self.ROTATION_CONSTANTS_FOR_WIDTH_1600[1][3])
            self.b[4][4] = CryptoHashes.leftRotateLong(self.laneArray[1][4], self.ROTATION_CONSTANTS_FOR_WIDTH_1600[1][4])

            self.b[0][4] = CryptoHashes.leftRotateLong(self.laneArray[2][0], self.ROTATION_CONSTANTS_FOR_WIDTH_1600[2][0])
            self.b[1][2] = CryptoHashes.leftRotateLong(self.laneArray[2][1], self.ROTATION_CONSTANTS_FOR_WIDTH_1600[2][1])
            self.b[2][0] = CryptoHashes.leftRotateLong(self.laneArray[2][2], self.ROTATION_CONSTANTS_FOR_WIDTH_1600[2][2])
            self.b[3][3] = CryptoHashes.leftRotateLong(self.laneArray[2][3], self.ROTATION_CONSTANTS_FOR_WIDTH_1600[2][3])
            self.b[4][1] = CryptoHashes.leftRotateLong(self.laneArray[2][4], self.ROTATION_CONSTANTS_FOR_WIDTH_1600[2][4])

            self.b[0][1] = CryptoHashes.leftRotateLong(self.laneArray[3][0], self.ROTATION_CONSTANTS_FOR_WIDTH_1600[3][0])
            self.b[1][4] = CryptoHashes.leftRotateLong(self.laneArray[3][1], self.ROTATION_CONSTANTS_FOR_WIDTH_1600[3][1])
            self.b[2][2] = CryptoHashes.leftRotateLong(self.laneArray[3][2], self.ROTATION_CONSTANTS_FOR_WIDTH_1600[3][2])
            self.b[3][0] = CryptoHashes.leftRotateLong(self.laneArray[3][3], self.ROTATION_CONSTANTS_FOR_WIDTH_1600[3][3])
            self.b[4][3] = CryptoHashes.leftRotateLong(self.laneArray[3][4], self.ROTATION_CONSTANTS_FOR_WIDTH_1600[3][4])

            self.b[0][3] = CryptoHashes.leftRotateLong(self.laneArray[4][0], self.ROTATION_CONSTANTS_FOR_WIDTH_1600[4][0])
            self.b[1][1] = CryptoHashes.leftRotateLong(self.laneArray[4][1], self.ROTATION_CONSTANTS_FOR_WIDTH_1600[4][1])
            self.b[2][4] = CryptoHashes.leftRotateLong(self.laneArray[4][2], self.ROTATION_CONSTANTS_FOR_WIDTH_1600[4][2])
            self.b[3][2] = CryptoHashes.leftRotateLong(self.laneArray[4][3], self.ROTATION_CONSTANTS_FOR_WIDTH_1600[4][3])
            self.b[4][0] = CryptoHashes.leftRotateLong(self.laneArray[4][4], self.ROTATION_CONSTANTS_FOR_WIDTH_1600[4][4])
    ...
    class Blake:
        ...
        def _compress(self):
            ...
            for i in range(16, 24, 1):
                v[i] = CryptoHashes.rshift(self._s[i - 16] ^ self.u512[i - 16], 0)
            for i in range(24, 32, 1):
                v[i] = np.int32(self.u512[i - 16])

            if not self._nullt:
                v[24] = CryptoHashes.rshift(v[24] ^ self._length[1], 0)
                v[25] = CryptoHashes.rshift(v[25] ^ self._length[0], 0)
                v[26] = CryptoHashes.rshift(v[26] ^ self._length[1], 0)
                v[27] = CryptoHashes.rshift(v[27] ^ self._length[0], 0)
                v[28] = CryptoHashes.rshift(v[28] ^ self._length[3], 0)
                v[29] = CryptoHashes.rshift(v[29] ^ self._length[2], 0)
                v[30] = CryptoHashes.rshift(v[30] ^ self._length[3], 0)
                v[31] = CryptoHashes.rshift(v[31] ^ self._length[2], 0)
            ...
            for i in range(16):
                self._h[(i % 8) * 2] = CryptoHashes.rshift(self._h[(i % 8) * 2] ^ v[i * 2], 0)
                self._h[(i % 8) * 2 + 1] = CryptoHashes.rshift(self._h[(i % 8) * 2 + 1] ^ v[i * 2 + 1], 0)

            for i in range(8):
                self._h[i * 2] = CryptoHashes.rshift(self._h[i * 2] ^ self._s[(i % 4) * 2], 0)
                self._h[i * 2 + 1] = CryptoHashes.rshift(self._h[i * 2 + 1] ^ self._s[(i % 4) * 2 + 1], 0)
        ...
        def rot(v, i, j, n):
            ...
            if n == 0:
                v[i * 2] = CryptoHashes.rshift(hi, 0)
                v[i * 2 + 1] = CryptoHashes.rshift(lo, 0)
            else:
                v[i * 2] = CryptoHashes.rshift(CryptoHashes.rshift(hi, n) | (lo << (32 - n)), 0)
                v[i * 2 + 1] = CryptoHashes.rshift(CryptoHashes.rshift(lo, n) | (hi << (32 - n)), 0)

        def g(self, v, m, i, a, b, c, d, e):

            # v[a] += (m[sigma[i][e]] ^ u512[sigma[i][e+1]]) + v[b]
            lo = np.int32(np.float32(v[a * 2 + 1]) + (
                CryptoHashes.rshift(m[self.sigma[i][e] * 2 + 1] ^ self.u512[self.sigma[i][e + 1] * 2 + 1], 0)) + np.float32(
                v[b * 2 + 1]))
            v[a * 2] = CryptoHashes.rshift(np.int32(np.float32(v[a * 2]) + (
                CryptoHashes.rshift(m[self.sigma[i][e] * 2] ^ self.u512[self.sigma[i][e + 1] * 2], 0)) + np.float32(
                v[b * 2]) + ~~np.uint64(lo / 0x0100000000)), 0)
            v[a * 2 + 1] = CryptoHashes.rshift(lo, 0)
            ...
            lo = np.int32(np.float32(v[a * 2 + 1]) + (
                CryptoHashes.rshift(m[self.sigma[i][e + 1] * 2 + 1] ^ self.u512[self.sigma[i][e] * 2 + 1], 0)) + np.float32(
                v[b * 2 + 1]))
            v[a * 2] = CryptoHashes.rshift(np.int32(np.float32(v[a * 2]) + (
                CryptoHashes.rshift(m[self.sigma[i][e + 1] * 2] ^ self.u512[self.sigma[i][e] * 2], 0)) + np.float32(
                v[b * 2]) + ~~np.uint64(lo / 0x0100000000)), 0)
            v[a * 2 + 1] = CryptoHashes.rshift(lo, 0)
    ...
    @staticmethod
    def sha3_512(data):
        k = CryptoHashes.Keccak1600(576, 1024, "", 512)
